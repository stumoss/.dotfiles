self: super: {
  userPackages = super.userPackages or { } // {
    ical2rem = super.writeScriptBin "ical2rem" ''
      #! /usr/bin/env nix-shell
      #! nix-shell -i perl -p perl perlPackages.iCalParser
      #
      # ical2rem.pl -
    ...
    propagatedBuildInputs = [ super.perlPackages.iCalParser ];
  };

  #self.systemd.services.crossfit-calendar = {
  #  serviceConfig = {
  #    User = "${self.config.users.users.stu}";
  #    ExecStart = "${self.curl} -s https://goteamup.com/users/ical/8ffea744dc0fd27afd66 | ${self.ical2rem} -m --lead-time 0 | tail -n +2 > $HOME/Documents/Calendars/crossfit.rem";
  #  };

  #  WantedBy = [ "default.target" ];
  #};

  #self.systemd.timers.crossfit-calendar-update = {
  #  timerConfig = {
  #    Unit = "crossfit-calenar.service";
  #    OnCalendar = "03:00";
  #  };
  #  WantedBy = [ "default.target" ];
  #};
